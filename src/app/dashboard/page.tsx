      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 space-y-6">
        ...
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div className="min-w-0">
            ...
            <h1 className="text-2xl font-semibold text-white tracking-tight">Welcome back, {userName}.</h1>
        ...
        {storeList.length === 0 && (
          <div className="flex items-center justify-center min-h-[60vh]">
            <div className="rounded-xl border border-white/[0.06] bg-white/[0.03] p-12 text-center max-w-lg w-full">
              <div className="mb-6">
                <svg className="mx-auto h-16 w-16 text-emerald-400/30" fill="none" viewBox="0 0 80 80" stroke="currentColor" strokeWidth="1.5">
              ...
              <p className="font-semibold text-white text-lg tracking-tight mb-2">Welcome to Provelo!</p>
